...
1) [**Midterm Review**]{.alert} (hosted by me): **Tuesday October 28, 2025** from **7:00 - 8:30 pm** in **BUCHN 1920**
   -  The plan is to review some material and thenwork through some new practice problems together
 
2) [**Midterm Advice**]{.alert}: write a note sheet (even though you don't technically get one on the exam)!
   -  Studies show: the act of writing things down and synthesizing information is a _great_ way to commit things to long-term memory.
   
3) [**Homework 5**]{.alert}: remember that it is due **5pm** on Wednesday (instead of 11:59pm), and that **no late submissions will be accepted for ANY reasons**
