...
Let _Y_ ~ Exp(β) for some β > 0, and define _U_ := _c_ _Y_ for some _c_ > 0. Use the CDF method to identify the distribution of _U_ **by name**, including any/all relevant parameter(s).
:::
