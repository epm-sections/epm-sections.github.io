...
Let _X_ ~ Exp(β) for some β > 0, and define _Y_ := _c_ _X_ for some _c_ > 0. Find the density _f_~_Y_(_y_) of _Y_ three different ways:

a)  Using the Method of Distribution Functions
b)  Using the Method of Transformations
c)  Using the Method of MGFs
:::
