...
To estimate a parameter $\theta$ given data $X_1, X_2, \cdots, X_n$, find the value of $\theta$ that was _most likely_ to have given rise to the data we observed.
:::
...
-   The [**likelihood**]{.alert} gives a way of answering the question: "given data $X_1, X_2, \cdots, X_n$, how likely was it that the true value of the parameter were $\theta$, for an arbitrary $\theta$?"
